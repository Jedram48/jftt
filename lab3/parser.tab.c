...
{
       0,   112,   112,   113,   116,   124,   132,   133,   134,   135,
     136,   144,   152,   153,   154
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "LBRACKET",
  "RBRACKET", "PLUS", "MINUS", "MULT", "DIV", "MOD", "POW", "NEG",
  "UMINUS", "END", "ERROR", "$accept", "input", "line", "expr", YY_NULLPTR
};
...
{
     -12,    19,   -12,   -11,   -12,    -2,     1,   -12,     7,   -12,
      22,   -12,    -2,    -2,    -2,    -2,    -2,    -2,   -12,   -12,
      26,    26,    13,    13,    13,    13
};
...
{
      10,     4,     5,     9,    11,     6,     0,    20,    21,    22,
      23,    24,    25,    12,    13,    14,    15,    16,    17,     2,
       3,    18,     4,     5,    17,     0,     6,    19,    12,    13,
      14,    15,    16,    17,    14,    15,    16,    17
};

static const yytype_int8 yycheck[] =
{
       5,     3,     4,    14,     3,     7,    -1,    12,    13,    14,
      15,    16,    17,     6,     7,     8,     9,    10,    11,     0,
       1,    14,     3,     4,    11,    -1,     7,     5,     6,     7,
       8,     9,    10,    11,     8,     9,    10,    11
};
...
{
       0,    17,     0,     1,     3,     4,     7,    18,    19,    14,
      19,     3,     6,     7,     8,     9,    10,    11,    14,     5,
      19,    19,    19,    19,    19,    19
};
...
#line 1191 "parser.tab.c"
  ...
  case 6: /* expr: NUM  */
#line 132 "parser.y"
                                { rpn += to_string(yyvsp[0]) + " "; yyval = GF(yyvsp[0]); }
#line 1197 "parser.tab.c"
    break;

  case 7: /* expr: expr PLUS expr  */
#line 133 "parser.y"
                                { rpn += "+ "; yyval = calculate(PLUS_OP, yyvsp[-2], yyvsp[0]); }
#line 1203 "parser.tab.c"
    break;

  case 8: /* expr: expr MINUS expr  */
#line 134 "parser.y"
                                { rpn += "- "; yyval = calculate(MINUS_OP, yyvsp[-2], yyvsp[0]); }
#line 1209 "parser.tab.c"
    break;

  case 9: /* expr: expr MULT expr  */
#line 135 "parser.y"
                                { rpn += "* "; yyval = calculate(MULT_OP, yyvsp[-2], yyvsp[0]); }
...
#line 136 "parser.y"
                                { rpn += "/ ";
                                  if (yyvsp[0] == 0) {
                                      ...
                                      yyval = calculate(DIV_OP, yyvsp[-2], yyvsp[0]);
                                  } 
                                }
...
#line 144 "parser.y"
                                { rpn += "% ";
                                  if (yyvsp[0] == 0) {
                                      ...
                                      yyval = calculate(MOD_OP, yyvsp[-2], yyvsp[0]);
                                  } 
                                }
#line 1241 "parser.tab.c"
    break;

  case 12: /* expr: MINUS NUM  */
#line 152 "parser.y"
                                { rpn += to_string(neg_num(yyvsp[0])) + " "; yyval = -yyvsp[0];}
#line 1247 "parser.tab.c"
    break;

  case 13: /* expr: expr POW expr  */
#line 153 "parser.y"
                                { rpn += "^ "; yyval = calculate(POW_OP, yyvsp[-2], yyvsp[0]); }
